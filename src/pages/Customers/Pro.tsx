...
//   const proLeads = customerTypeLeads.Pro;

//   return (
//     <div className="container mx-auto px-4 py-8">
//       <h1 className="text-2xl font-bold mb-6">Pro Customers</h1>
...
//             No Pro Customers yet
//           </h3>
//           <p className="mt-1 text-sm text-muted-foreground">
//             Mark leads as Pro in the Leads table to see them here.
//           </p>
//         </div>
//       ) : (
