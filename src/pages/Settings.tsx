...
//     "profile" | "kpis" | "fields" | "onboarding"
//   >("profile");
...
//                         className="pl-10 w-full rounded-lg border border-input px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent shadow-sm transition"
...
//                     type="submit"
//                     disabled={loading}
//                     className={`w-full md:w-auto flex justify-center items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-primary-foreground transition-all ${
//                       loading
//                         ? "bg-muted cursor-not-allowed"
//                         : "bg-gradient-to-r from-primary to-indigo-700 hover:from-blue-700 hover:to-indigo-800"
//                     }`}
//                   >
//                     {loading ? (
//                       <>
...
//                         className="w-full rounded-lg border border-input px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent shadow-sm transition"
...
//                   className={`mt-6 w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-primary-foreground transition-all ${
//                     !newKpiLabel.trim()
//                       ? "bg-muted cursor-not-allowed"
//                       : "bg-gradient-to-r from-primary to-indigo-700 hover:from-blue-700 hover:to-indigo-800"
//                   }`}
...
//                         <div
//                           key={kpi.id}
//                           className="border border-border rounded-xl p-4 flex items-center justify-between transition-all hover:shadow-md"
//                         >
//                           <div className="flex items-center">
//                             <div
...
//                   className="mt-6 w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-primary-foreground bg-gradient-to-r from-primary to-indigo-700 hover:from-blue-700 hover:to-indigo-800 transition-all"
//                 >
//                   <Plus className="h-5 w-5 mr-2" />
//                   Add Custom Field
//                 </button>
...
//             <div className="space-y-6">
//               <div className="bg-gradient-to-r from-primary/10 to-indigo-50 rounded-xl p-5 border border-primary/20">
//                 {/* Tab Headers */}
...
//                           className="px-6 py-2.5 rounded-lg font-medium bg-gradient-to-r from-success to-emerald-700 text-primary-foreground hover:from-green-700 hover:to-emerald-800 shadow-sm"
//                         >
//                           Complete Onboarding
//                         </button>
//                       </div>
