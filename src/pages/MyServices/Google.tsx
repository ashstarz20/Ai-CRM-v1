      ...
      {loading ? (
        <div className="flex justify-center items-center h-64">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Loading Google services data...</p>
          </div>
        </div>
      ) : (
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl shadow p-6 border border-purple-100">
              <h3 className="text-lg font-semibold text-gray-700 mb-2">Monthly Spend</h3>
              <div className="flex items-end justify-between">
                <span className="text-3xl font-bold text-purple-600">$4,250</span>
            ...
            <div className="bg-white rounded-xl shadow p-6 border border-amber-100">
              <h3 className="text-lg font-semibold text-gray-700 mb-2">Avg. Cost/Click</h3>
              <div className="flex items-end justify-between">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <Chart
                ...
                options={{
                  ...
                  legend: { position: 'labeled', textStyle: { color: '#4B5563', fontSize: 14 } },
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <Chart
                ...
                options={{
                  ...
                  backgroundColor: 'transparent',
                  legend: { position: 'top', alignment: 'center', textStyle: { color: '#4B5563' } },
                  titleTextStyle: { color: '#1F2937', fontSize: 18, bold: true },
                  hAxis: {
                    title: 'Count',
          ...
          <div className="bg-white rounded-xl shadow-md p-6 mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-6">Service Metrics & Progress</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {services.map((service, index) => {
                const percentage = calculatePercentage(service.value, service.target);
                  ...
                  <div key={index} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="text-sm font-semibold">
                        {service.value}{service.isPercent ? '%' : ''} 
                        <span className="text-gray-500"> / {service.target}{service.isPercent ? '%' : ''}</span>
                      </span>
                    </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            <button className="px-6 py-3 bg-blue-600 text-white font-medium rounded-lg shadow hover:bg-blue-700 transition-colors flex items-center">
            ...
            <button className="px-6 py-3 bg-white text-gray-800 font-medium rounded-lg shadow border border-gray-300 hover:bg-gray-50 transition-colors flex items-center">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className="px-6 py-3 bg-green-600 text-white font-medium rounded-lg shadow hover:bg-green-700 transition-colors flex items-center">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
